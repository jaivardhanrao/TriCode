const questions = [
  ...
  let preBuilt =
    "Give me mental health response according to the responses to a quiz a person made the responses are as follows. and dont use any kind of star of any other symbol in your response just plain text no bold italic nothing ";
  let selectedAnswers = [];
